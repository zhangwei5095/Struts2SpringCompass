package com.ourfuture.compass.dao.impl;
...
import com.ourfuture.compass.dao.ProductDao;
...
public class ProductDaoImpl extends HibernateDaoSupport implements ProductDao {
	...
	public List<Product> listAll(int pageNumber, int pageSize) {
		...
		Query query =session.createQuery(" from com.ourfuture.compass.model.Product product ");
