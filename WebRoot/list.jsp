...
<body>
	...
	<table width="80%" border="1" bordercolor="#000000" style="border-collapse: collapse;" align="center">
		...
		<tr align="center">
			...
			<td><a href="productAction!get.action?product.id=<s:property escape="false" value="#product.id"/>">修改</a></td>
			<td><a href="productAction!delete.action?product.id=<s:property escape="false" value="#product.id"/>">删除</a></td>
		</tr>
		</s:iterator>
	</table>
	<hr>
